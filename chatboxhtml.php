...
<body style = "background-image:url('bg.jpg'); background-size:cover;">
		...
		<div class="chatbox-message-wrapper">
			<div class="chatbox-message-header">
				<div class="chatbox-message-profile">
					<img src="C:\Users\vatsp\OneDrive\Desktop\Guard Dashboard\guarddashboard.png" alt="" class="chatbox-message-image">
					<div>
						<h4 class="chatbox-message-name">Guard</h4>
	...
	<script src="chatboxjs.js"></script>
</body>
</html>